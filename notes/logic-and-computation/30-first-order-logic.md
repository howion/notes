...
2. For all $n \geq 1$, if $t_1, ..., t_n$ are terms, then $f_n \> t_1 \cdots t_n$ and $R_n \> t_1 \cdots t_n$ are also terms where $f_n \in S$ is an $n$-ary function and $R_n \in S$ is an $n$-ary relation.
