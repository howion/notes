...
The set $L$ is the **lattice** spanned by $\vec{a}, \vec{b} \in \R^2$ so that $L$ consists of all linear combinations $m\vec{a} + n\vec{b}$ where $m,n \in \Z$.
