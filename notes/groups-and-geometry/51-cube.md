...
1. A cube has 24 rotations in total that consists of
    ...
    4. the identity
1. $G \cong \bold{S}_4 \times \Z_2$ where $\bold{S}_4$ consists of rotations and $\Z_2$ consists of $\Set{1,d}$ where $d$ is the **central inversion**.
2. The reflections forms the group $\bold{S}_4$.
3.
2. $|G|=48$
