...
## _Thm._ Basic Element Order Properties
...
## _Thm._ Basic Cyclic Properties
...
## _Thm._ Fundamental Order Property
...
## _Thm._ Every Subgroup of $\Z$ is Also Cyclic
...
## _Thm._ Same Order Cyclics are Isomorphic
...
## _Thm._ Fundamentals of Element Orders
...
## _Thm._ Orders of Commutative Elements
...
## _Thm._ On Generators of Cyclics
...
3. For every integer $m$ we have $\Braket{x^m} = \Braket{x^{-m}}$. Therefore, every non-trivial subgroup of $H$...

## _Thm._ Homomorphisms from Cyclics
...
## _Thm._ Finitely Many Subgroups Imply Finite Group
