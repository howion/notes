...
Assume we are given a homogeneous diffusion (heat) equation with Neumann conditions so that
...
Assume we are given a homogeneous wave equation with Neumann conditions so that
