...
* **Ideals, Varieties, and Algorithms: _An Introduction to Computational Algebraic Geometry and Commutative Algebra_** by David Cox, John Little, and Donal O’Shea
...
<!-- * Instead of $\text{deg}(f)$, we will use $d(f)$ to denote the (total) degree. -->
